...
class AssetManagerMixin:
    def _load_ui_image(self, filename: str, size: tuple[int, int] | None = None):
        try:
            ...
            print(f"[WARN] Khong load duoc UI image {filename}: {exc}")
            return None
    ...
    def _load_assets(self) -> None:
        ...
        self.ui_pause_button = self.sprite_loader.load_image(
            get_icon_path("pause"),
            size=(58, 58),
            fallback_color=(90, 130, 230),
            fallback_text="II",
        )
        self.ui_left_button = self.sprite_loader.load_image(
            get_icon_path("left"),
            size=(54, 54),
            fallback_color=(65, 180, 85),
            fallback_text="<",
        )
        self.ui_right_button = self.sprite_loader.load_image(
            get_icon_path("right"),
            size=(54, 54),
            fallback_color=(65, 180, 85),
            fallback_text=">",
